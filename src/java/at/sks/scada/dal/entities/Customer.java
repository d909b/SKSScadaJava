...
@NamedQueries({
    ...
    @NamedQuery(name = "Customer.findByNameAndPassword", 
        query = "SELECT c FROM Customer c WHERE c.personID IN (SELECT p.personID FROM Person p WHERE p.username = :name AND p.password = :password)"),
